...
import { Compass, ArrowRight, Sparkles, MapPin, Globe } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex">
      ...
      <div className="hidden lg:flex lg:w-[52%] relative flex-col overflow-hidden bg-amber-500">
        ...
        <div className="absolute top-1/2 right-8 w-32 h-32 rounded-full bg-white/[0.07]" />
        <div
        ...
        <div className="relative z-10 flex flex-col h-full p-14">
          ...
          <div className="flex-1 flex flex-col justify-center max-w-sm">
            ...
            <p className="text-white/75 text-base leading-relaxed mb-10">
              AI-powered trip planning that turns your travel dreams into detailed, day-by-day itineraries.
            </p>
            <div className="space-y-3.5">
              {[
                { icon: Sparkles, label: "AI-generated recommendations" },
                { icon: MapPin, label: "Organize destinations effortlessly" },
                { icon: Globe, label: "Plan unlimited trips for free" },
              ].map((item) => (
      ...
      <div className="flex-1 flex items-center justify-center p-8 bg-white dark:bg-gray-950 transition-colors">
        <div className="w-full max-w-[360px]">
          ...
          <div className="mb-8">
            ...
            <p className="text-gray-400 dark:text-gray-500 text-sm">Sign in to continue your trip planning</p>
          </div>
          ...
          <p className="text-center text-xs text-gray-400 dark:text-gray-500 mt-6">
            No account?{" "}
            <Link href="/auth/register" className="text-amber-600 hover:text-amber-500 font-semibold">
              Create one free
            </Link>
          </p>
        </div>
